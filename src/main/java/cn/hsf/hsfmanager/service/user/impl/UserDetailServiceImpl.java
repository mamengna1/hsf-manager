...
public class UserDetailServiceImpl implements UserDetailService {
    ...
    @Override
    public List<UserDetail> selPaiDanAll(Integer pageCurrentNo, Integer pageSize, String skillId, Integer workProvince, Integer workCity, String workArea) {
        return userDetailMapper.selPaiDanAll((pageCurrentNo-1)*pageSize, pageSize, skillId, workProvince, workCity, workArea);
    }

    @Override
    public int selPaiDanTotal(String skillId, Integer workProvince, Integer workCity, String workArea) {
