    ...
    function callback(data) {
        ...
        for (var i = 0; i < data.list.length; i++) {
            ...
            $("#theBody").append("<tr>" +
                ...
                "<a href='javascript:void(0)'  class=\"btn bg-olive btn-xs\" data-toggle=\"modal\" data-target=\"#auditModal\" onclick='selAudit(\""+data.list[i].id+"\")' style=\"" + (( a == 3) ? '' : 'display:none;') + "\">再次审核</a>" +
                "<span   class=\"btn bg-olive btn-xs\" style=\"" + ((a == 2 ) ? '' : 'display:none;')+"\">审核失败</span>"+
                "</td>" +
                "</tr>")
